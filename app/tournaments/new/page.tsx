...
//   return (
//     <main className="min-h-screen flex items-center justify-center px-6 py-12 bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
//       <form
//         onSubmit={handleSubmit}
//         className="w-full max-w-2xl bg-white bg-opacity-90 backdrop-blur-md rounded-xl p-10
//           shadow-lg border border-gray-500
//           transition-shadow duration-300
//           hover:shadow-2xl"
//       >
//         <h1 className="text-4xl font-bold text-center text-indigo-600 mb-10">🎮 Nowy Turniej</h1>
...
//               transition-shadow duration-200 hover:shadow-md focus:shadow-lg"
//           />
//         </FormField>
...
//         <button
//           type="submit"
//           className="w-full py-3 mt-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600
//             hover:from-pink-600 hover:via-indigo-600 hover:to-purple-600
//             text-white font-semibold rounded-xl shadow-md transition-all duration-200"
//         >
//           🚀 Stwórz turniej
//         </button>
//       </form>
