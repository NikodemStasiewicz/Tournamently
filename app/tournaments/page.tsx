...
//   return (
//     <main className="min-h-screen w-full bg-gradient-to-br from-indigo-100 via-white to-indigo-200 py-16 px-6">
//       <div className="max-w-6xl mx-auto">
//         <h1 className="text-4xl font-extrabold text-slate-800 mb-12 text-center drop-shadow-sm">
//           🎮 Przeglądaj Turnieje
//         </h1>
...
//               <div
//                 key={tournament.id}
//                 className="backdrop-blur-md bg-white/70 border border-slate-200 rounded-2xl shadow-lg p-6 flex flex-col justify-between transition-transform hover:-translate-y-1 hover:shadow-xl"
//               >
//                 <div>
...
//                     <span className="font-medium">Miejsca:</span> {filled} /{" "}
//                     {limit}
//                   </p>
...
//                   <p className="text-slate-500 text-xs flex items-center gap-2 mt-3">
//                     <CalendarDaysIcon className="w-4 h-4 text-slate-400" />
//                     {format(new Date(tournament.createdAt), "d MMMM yyyy, HH:mm", {
//                       locale: pl,
//                     })}
//                   </p>
//                 </div>
